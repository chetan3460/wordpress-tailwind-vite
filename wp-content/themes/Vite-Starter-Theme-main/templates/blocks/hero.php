    ...
    <div class="container relative">
        <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
            <div class="md:col-span-6">
                <div class="md:me-6">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/images/logo-icon-40.png" class="mb-5" alt="">
                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    <div class="col-span-5">
                        <div class="grid grid-cols-1 gap-4">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/images/digital/02.jpg" class="shadow rounded-lg" alt="">
                    ...
                    <div class="col-span-7">
                        <div class="grid grid-cols-1 gap-4">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/images/digital/01.jpg" class="shadow rounded-lg" alt="">
                        </div>
                    </div>
                </div>
            </div><!--end col-->
