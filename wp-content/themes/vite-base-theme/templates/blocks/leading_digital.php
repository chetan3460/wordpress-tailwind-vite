<section class="py-20 w-full table relative bg-[url('../images/digital/bg01.jpg')]  bg-center bg-no-repeat bg-cover">
    <div class="container relative">
        <div class="flex">
            <div class="lg:w-1/3 md:w-1/2 sm:w-2/3 p-6 rounded-md shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900">
                ...
                <h4 class="mb-4 md:text-[28px]] text-2xl leading-normal font-bold">Leading Digital <br> Business For <span class="text-indigo-600 typewrite" data-period="2000" data-type="[ &quot;Agency&quot;, &quot;Software&quot;, &quot;Technology&quot;, &quot;Studio&quot;, &quot;Webapps&quot; ]"><span class="wrap">Software</span></span> <br> Solution.</h4>
