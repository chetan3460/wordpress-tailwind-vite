...
<?= get_template_part('template-parts/common/intro') ?>
<?= get_template_part('template-parts/about/image-grid-block') ?>
<?= get_template_part('template-parts/about/stats-block') ?>
<?= get_template_part('template-parts/about/purpose-block') ?>
<?= get_template_part('template-parts/about/drive-block') ?>
<?= get_template_part('template-parts/about/journey-block') ?>
<?= get_template_part('template-parts/about/bod-block') ?>
<?= get_template_part('template-parts/about/manufacturing-block') ?>
<?= get_template_part('template-parts/about/initiatives-block') ?>
<?= get_template_part('template-parts/about/stories-block') ?> -->
